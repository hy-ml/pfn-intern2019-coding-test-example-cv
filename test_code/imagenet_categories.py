imagenet_categories = [
    ...
    ['great_white_shark', 'white_shark', 'man-eater',
     'man-eating_shark', 'Carcharodon_carcharias'],
    ...
    ['Komodo_dragon', 'Komodo_lizard', 'dragon_lizard',
     'giant_lizard', 'Varanus_komodoensis'],
    ...
    ['platypus', 'duckbill', 'duckbilled_platypus',
     'duck-billed_platypus', 'Ornithorhynchus_anatinus'],
    ['wallaby', 'brush_kangaroo'],
    ['koala', 'koala_bear', 'kangaroo_bear',
     'native_bear', 'Phascolarctos_cinereus'],
    ['wombat'],
    ['jellyfish'],
    ['sea_anemone', 'anemone'],
    ['brain_coral'],
    ...
    ['fiddler_crab'],
    ['king_crab', 'Alaska_crab', 'Alaskan_king_crab',
     'Alaska_king_crab', 'Paralithodes_camtschatica'],
    ['American_lobster', 'Northern_lobster',
     'Maine_lobster', 'Homarus_americanus'],
    ['spiny_lobster', 'langouste', 'rock_lobster',
     'crawfish', 'crayfish', 'sea_crawfish'],
    ...
    ['albatross', 'mollymawk'],
    ['grey_whale', 'gray_whale', 'devilfish',
     'Eschrichtius_gibbosus', 'Eschrichtius_robustus'],
    ...
    ['American_Staffordshire_terrier', 'Staffordshire_terrier',
     'American_pit_bull_terrier', 'pit_bull_terrier'],
    ['Bedlington_terrier'],
    ['Border_terrier'],
    ['Kerry_blue_terrier'],
    ['Irish_terrier'],
    ...
    ['Siamese_cat', 'Siamese'],
    ['Egyptian_cat'],
    ['cougar', 'puma', 'catamount', 'mountain_lion',
     'painter', 'panther', 'Felis_concolor'],
    ['lynx', 'catamount'],
    ...
    ['dragonfly', 'darning_needle', "devil's_darning_needle", 'sewing_needle',
     'snake_feeder', 'snake_doctor', 'mosquito_hawk', 'skeeter_hawk'],
    ['damselfly'],
    ['admiral'],
    ...
    ['bison'],
    ['ram', 'tup'],
    ['bighorn', 'bighorn_sheep', 'cimarron', 'Rocky_Mountain_bighorn',
     'Rocky_Mountain_sheep', 'Ovis_canadensis'],
    ['ibex', 'Capra_ibex'],
    ['hartebeest'],
    ...
    ['lesser_panda', 'red_panda', 'panda',
     'bear_cat', 'cat_bear', 'Ailurus_fulgens'],
    ['giant_panda', 'panda', 'panda_bear', 'coon_bear', 'Ailuropoda_melanoleuca'],
    ['barracouta', 'snoek'],
    ['eel'],
    ['coho', 'cohoe', 'coho_salmon', 'blue_jack',
     'silver_salmon', 'Oncorhynchus_kisutch'],
    ...
    ['apiary', 'bee_house'],
    ['apron'],
    ['ashcan', 'trash_can', 'garbage_can', 'wastebin', 'ash_bin',
     'ash-bin', 'ashbin', 'dustbin', 'trash_barrel', 'trash_bin'],
    ...
    ['beach_wagon', 'station_wagon', 'wagon', 'estate_car',
     'beach_waggon', 'station_waggon', 'waggon'],
    ...
    ['carton'],
    ['car_wheel'],
    ['cash_machine', 'cash_dispenser', 'automated_teller_machine',
     'automatic_teller_machine', 'automated_teller', 'automatic_teller', 'ATM'],
    ['cassette'],
    ['cassette_player'],
    ['castle'],
    ['catamaran'],
    ...
    ['chain'],
    ['chainlink_fence'],
    ['chain_mail', 'ring_mail', 'mail', 'chain_armor',
     'chain_armour', 'ring_armor', 'ring_armour'],
    ['chain_saw', 'chainsaw'],
    ['chest'],
    ['chiffonier', 'commode'],
    ['chime', 'bell', 'gong'],
    ...
    ['Loafer'],
    ['lotion'],
    ['loudspeaker', 'speaker', 'speaker_unit',
     'loudspeaker_system', 'speaker_system'],
    ...
    ['pole'],
    ['police_van', 'police_wagon', 'paddy_wagon',
     'patrol_wagon', 'wagon', 'black_Maria'],
    ['poncho'],
    ...
    ['toyshop'],
    ['tractor'],
    ['trailer_truck', 'tractor_trailer', 'trucking_rig',
     'rig', 'articulated_lorry', 'semi'],
    ['tray'],
    ['trench_coat'],
    ...
    ['rapeseed'],
    ['daisy'],
    ["yellow_lady's_slipper", 'yellow_lady-slipper',
     'Cypripedium_calceolus', 'Cypripedium_parviflorum'],
    ['corn'],
    ['acorn'],
    ...
    ['earthstar'],
    ['hen-of-the-woods', 'hen_of_the_woods',
     'Polyporus_frondosus', 'Grifola_frondosa'],
    ['bolete'],
    ['ear', 'spike', 'capitulum'],
